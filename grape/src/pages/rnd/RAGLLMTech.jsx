...
import { getRndRagLlmData } from '../../data/i18n/rndRagLlm';

const RAGLLMTech = () => {
  const { t, currentLang } = useTranslation();
  const d = getRndRagLlmData(currentLang);
  return (
    <BaseLayout
    ...
    >
      <div className="product-page-content">
          ...
          <div className="rnd-feature-cards-section">
            <div className="rnd-feature-description-container">
              <div className="rnd-feature-description-image-section">
                <img src={rag} alt="feature" className="rnd-feature-description-image" />
              </div>
        ...
        <div className="gs-container">
          ...
          <section className="gs-section">
            <h3><span className="num">5</span> {d.sections.applications}</h3>
            <ul className="gs-list">
              {d.applications.map((item, idx) => (
                <li key={idx}>{item}</li>
              ))}
            </ul>
          </section>
