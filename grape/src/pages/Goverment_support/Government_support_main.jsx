 ...
 * SelectCardList를 통해 정부지원사업을 선택하고, CaseGrid로 선택된 사업의 정보를 보여줍니다.
 * 
 * 주요 기능:
 * - 4개의 정부지원사업 중 선택 가능
 * - 선택된 사업의 상세 정보 표시
...
const Government_support_main = () => {
  ...
  // 각 정부지원사업별 데이터 정의 (CaseGrid 형식에 맞게 조정)
  const solutionDataArray = [
    {
      id: 1,
      category: "정부지원사업",
      company: "스마트 안전장비지원사업",
      title: "Smart Safety Equipment Support",
