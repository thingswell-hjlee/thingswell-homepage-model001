                ...
                <div className="about-section-title-image-container">
                  ...
                  <div className="about-section-content-container">
                    ...
                    <div className="about-section-title-image-description">
                      <p>
                        (주)싱스웰(Thingswell Co., Ltd.)은 AI 에이전트를 활용한
                        멀티모달 상황 인지를 기반으로, 근로자와 노인, 장애인을
                        위한 안전·자동화 플랫폼 솔루션에 특화된 기업입니다.
                        다양한 센서(음향·영상·동작 등)와 무선 통신, 빅데이터
                        분석 기술을 결합하여 실시간으로 주변 환경을 모니터링하고
                        이상 상태를 조기에 감지함으로써, 사고를 예방하고 긴급
                        상황에서 즉각적인 대응이 가능하도록 지원합니다.
                      </p>
                      <h2>(주) 싱스웰 대표이사</h2>
                      <h3>이 학 준</h3>
                    </div>
