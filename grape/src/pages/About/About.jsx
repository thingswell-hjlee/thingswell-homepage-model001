                ...
                <div className="about-section-title-image-container">
                  ...
                  <div className="about-section-content-container">
                    ...
                    <div className="about-section-title-image-description">
                      ...
                      <ul>
                        <li>
                          <strong>다중 센서 융합:</strong> 음향·영상·바이탈 신호 등 복합 데이터를 AI 에이전트가 실시간으로 처리하여, 위험 요소 및 이상 동작을 빠르고 정확하게 파악
                        </li>
                        <li>
                          <strong>현장 맞춤형 알고리즘:</strong> 근로자 안전 지침과 노인·장애인의 활동 패턴을 고려한 머신러닝 모델을 구축해, 예측·분석의 정확도를 향상
                        </li>
                      </ul>

                      <h3>자동화 플랫폼 및 통합 솔루션</h3>
                      <ul>
                        <li>
                          <strong>클라우드-엣지 연계:</strong> 고성능 엣지 디바이스를 통해 현장에서 데이터를 즉시 분석하고, 클라우드 서버와 연동하여 대규모 빅데이터 학습·관리
                        </li>
                        <li>
                          <strong>상황별 자동 제어:</strong> 위험 상황이 감지되면 자동 방재·경보 시스템을 구동하거나, 사용자의 이동 및 활동을 보조하는 로봇·웨어러블 장치와 연계
                        </li>
                      </ul>

                      <h3>사용자 중심의 직관적 인터페이스</h3>
                      <ul>
                        <li>
                          <strong>UI/UX 최적화:</strong> 간단한 디스플레이·음성 안내 등을 통해 노인·장애인도 쉽게 이용 가능하도록 인터페이스 설계
                        </li>
                        <li>
                          <strong>모바일 연동 관리:</strong> 모바일 앱 및 웹 대시보드를 통해 상태 모니터링, 긴급 알림, 데이터 분석 리포트 등을 제공
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li>
                          <strong>지속적인 R&D 투자:</strong> 대학·연구기관 및 글로벌 파트너들과의 협업을 통해 신소재 센서, AI 알고리즘, 에너지 효율 설계 등을 지속적으로 고도화
                        </li>
                        <li>
                          <strong>포용적 사회 실현:</strong> 누구나 안전하고 편리하게 생활·작업할 수 있는 환경을 구축함으로써, 사회적 약자를 포함한 모든 계층에 실질적인 도움 제공
                        </li>
                        <li>
